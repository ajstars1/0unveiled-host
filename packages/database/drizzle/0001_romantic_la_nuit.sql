...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."leaderboard_type" AS ENUM('GENERAL', 'TECH_STACK', 'DOMAIN');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "LeaderboardScore" (
	"id" text PRIMARY KEY NOT NULL,
	"userId" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "ShowcasedItemSkills" (
	"showcasedItemId" text NOT NULL,
	"skillId" text NOT NULL,
	CONSTRAINT "ShowcasedItemSkills_showcasedItemId_skillId_pk" PRIMARY KEY("showcasedItemId","skillId")
);
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "LeaderboardScore_userId_idx" ON "LeaderboardScore" USING btree ("userId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "LeaderboardScore_leaderboardType_idx" ON "LeaderboardScore" USING btree ("leaderboardType");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "LeaderboardScore_rank_idx" ON "LeaderboardScore" USING btree ("rank");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "ShowcasedItemSkills_showcasedItemId_idx" ON "ShowcasedItemSkills" USING btree ("showcasedItemId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ShowcasedItemSkills_skillId_idx" ON "ShowcasedItemSkills" USING btree ("skillId");--> statement-breakpoint
