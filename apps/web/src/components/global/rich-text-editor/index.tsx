        ...
        <EditorRoot>
          <EditorContent
            className={cn(
              inline
                ? onEdit && "mb-5"
                : "border rounded-lg px-10 py-5  text-base border-themeGray bg-themeBlack w-full",
            )}
            ...
            editorProps={{
              ...
              attributes: {
                class: `prose prose-lg dark:prose-invert focus:outline-hidden max-w-full [&_h1]:text-4xl [&_h2]:text-3xl [&_h3]:text-2xl text-themeTextGray`,
              },
            }}
            extensions={[
              ...defaultExtensions,
